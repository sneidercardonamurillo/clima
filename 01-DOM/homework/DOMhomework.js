...
span.innerHTML= span.innerHTML + ' cardona'
...
function buildToDo(todo, index) {
  ...
  if(todo.complete){
    toDoText.className = 'mision cumplit';
  }
...
function displayToDos() {
  ...
  // tambien se puede hacer con un forEarch
  // build.forEarch(e => toDoContainer.appendChild(e));
}
